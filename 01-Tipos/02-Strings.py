...
# imprime el primer caracter de la variable nombre_curso
...
# *Si quiero escribir una descripsion o mensaje largo, puedo usar
# triple comillas dobles.
# *si seleccionamos y abrimos parentesis, comillas y corchetes
# python autompleta y cierraparentesis, comillas y corchetes.
